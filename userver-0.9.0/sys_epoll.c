...
long epoll_wait(int epfd, struct epoll_event *events, int maxevents,
  int timeout);

_syscall1(int, epoll_create, int, size);
_syscall4(int, epoll_ctl, int, epfd, int, op, int, fd, struct epoll_event *,
  events);
_syscall4(long, epoll_wait, int, epfd, struct epoll_event *, events, int,
  maxevents, int, msec_timeout);
...
long
sys_epoll_wait(int epfd, struct epoll_event *events, int maxevents,
  int timeout)
{
...
long
__ia64_syscall(long a0, long a1, long a2, long a3, long a4, long nr)
{
