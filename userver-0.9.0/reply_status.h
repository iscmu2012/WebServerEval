...
#define HTTP_PARTIAL_CONTENT_STR_ID_LEN_TYPE_NOBLANK "HTTP/1.%d 206 Partial Content\r\nServer: %s" \
   "\r\nAccept-Ranges: bytes\r\nContent-Length: %lu\r\nContent-Type: %s\r\nContent-Range: bytes %zd-%zd/%lld\r\n"
#define HTTP_PARTIAL_CONTENT_STR_ID_LEN_TYPE HTTP_PARTIAL_CONTENT_STR_ID_LEN_TYPE_NOBLANK "\r\n"

#define HTTP_PARTIAL_CONTENT_STR_ID_LEN_NOBLANK "HTTP/1.%d 206 Partial Content\r\nServer: %s"\
   "\r\nAccept-Ranges: bytes\r\nContent-Length: %lu\r\nContent-Range: bytes %zd-%zd/%lld\r\n"
#define HTTP_PARTIAL_CONTENT_STR_ID_LEN HTTP_PARTIAL_CONTENT_STR_ID_LEN_NOBLANK "\r\n"
