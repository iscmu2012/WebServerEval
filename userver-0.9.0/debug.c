...
#ifdef MAXOPENFD
    printf
      ("%8ld usec (sd = %6d /%2d / %2d : %6d /%2d / %2d) %6d %6d %6d [%6d|%6d] ",
      diff, sd, fsm_state, got_hup, peer_sd, peer_state, peer_got_hup, max_sd,
      num_idle, max_opensd, conn, req);
#else
    printf
      ("%8ld usec (sd = %6d /%2d / %2d : %6d /%2d / %2d) %6d %6d [%6d|%6d] ",
      diff, sd, fsm_state, got_hup, peer_sd, peer_state, peer_got_hup, max_sd,
      num_idle, conn, req);
#endif /* MAXOPENFD */
    printf(" %s : %d -- ", func, line);
